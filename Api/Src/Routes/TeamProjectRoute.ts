...
const courseRoute = (controller: TeamProjectController) => {
    return (router: express.Router) => {
        ...
        router.route("/mentors/me/:mentorId/projects").get(HasId('mentorId'), idsValidation(), controller.getTeamProjectsByMentorId);
        router.route("/mentors/me/:id/projects").post(HasId('id'), idValidation, controller.createTeamProjectForMentor);
        router.route("/mentors/me/:mentorId/projects/:id").put(HasId('mentorId'), idsValidation(), controller.updateTeamProjectForMentor);
        router.route("/mentors/me/:mentorId/projects/:id").delete(HasId('mentorId'), idsValidation(), controller.deleteTeamProjectForMentor);
