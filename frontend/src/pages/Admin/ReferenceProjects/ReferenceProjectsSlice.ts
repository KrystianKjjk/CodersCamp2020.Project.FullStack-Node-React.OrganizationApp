...
export const fetchRefProjects: any = createAsyncThunk(
  'refProjects/fetchAll',
  async () => {
...
export const addRefProject: any = createAsyncThunk(
  'refProjects/addProject',
  async (project) => {
...
export const deleteRefProject: any = createAsyncThunk(
  'refProjects/deleteProject',
...
export const updateRefProject: any = createAsyncThunk(
  'refProjects/updateProject',
  async (project) => {
...
export const referenceProjectsSlice = createSlice({
  ...
  extraReducers: {
    ...
    [deleteRefProject.fulfilled]: (state, action) => {
      if (state.loading) state.loading = false
      state.refProjects = state.refProjects.filter(
...
export const {
  ...
  clearActionSuccess,
  clearLoaded,
} = referenceProjectsSlice.actions
